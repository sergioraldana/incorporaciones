        ...
        <div class="flex-grow w-full max-w-full mx-auto xl:px-8 lg:flex">
            ...
            <div class="flex-1 min-w-0 xl:flex">
                ...
                <div class="lg:min-w-0 lg:flex-1">
                    <div class="h-full py-0 px-0 sm:px-0 lg:px-0">
                        <!-- Start main area-->
                        <div class="relative h-full" style="min-height: 36rem;">

                            <!-- Cabecera de la solicitud-->
                            <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                                <div class="bg-white py-5 border-b border-gray-200 sm:px-6">
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-4">
                                                    <h3 class="text-lg leading-6 font-medium text-gray-900">
                                                        Solictud de
                                                        <span class="px-2 inline-flex leading-6 rounded-full bg-yellow-100 text-yellow-800">
                                          Incorporación
                                        </span>
                                    ...
                                    Contactar
                                            ...
                                            <button type="button" class="ml-3 relative inline-flex items-center px-4 py-2 shadow-sm text-sm font-medium rounded-md text-gray-200 bg-blue-700 hover:bg-blue-700-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                                <svg class="-ml-1 mr-2 h-5 w-5 text-gray-200" x-description="Heroicon name: solid/mail" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                                ...
                                                <div>
                                                    <div>
                                                        ...
                                                        <p class="mt-1 max-w-2xl text-sm text-gray-500">
                                                            Detalles personales del solicitante
                                                        </p>
                                                    </div>
                                            ...
                                            <div class="max-w-4xl mx-auto">
                                                ...
                                                <div>
                                                    <div>
                                                        ...
                                                        <p class="mt-1 max-w-2xl text-sm text-gray-500">
                                                            Detalles académicos de la solicitud
                                                        </p>
                                                    </div>
                                                    <div class="mt-5 border-t border-gray-200">
                                                        <dl class="sm:divide-y sm:divide-gray-200">
                                                            ...
                                                            <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4">
                                                                ...
                                                                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus assumenda consectetur culpa cumque dolores esse explicabo fugiat in libero nemo nisi, perspiciatis quae quaerat quia quisquam recusandae reprehenderit totam vitae!
                                                                </dd>
                                                            </div>
                                                            <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4">
                                                                <dt class="text-sm font-medium text-gray-500">
            ...
            <div class="pr-4 sm:pr-6 lg:pr-8 lg:flex-shrink-0 xl:pr-0">
                <div class="h-full pl-6 py-0 lg:w-80">
                    <!-- Start right column area -->
                    <div class="h-full relative" style="min-height: 16rem;">


                        <!-- Estado actual-->
                        <div class="px-6 flex py-8 bg-gray-200 rounded mb-6">
                                ...
                                <li>
                                  ...
                                  <path fill-rule="evenodd" d="M18 5v8a2 2 0 01-2 2h-5l-5 4v-4H4a2 2 0 01-2-2V5a2 2 0 012-2h12a2 2 0 012 2zM7 8H5v2h2V8zm2 0h2v2H9V8zm6 0h-2v2h2V8z" clip-rule="evenodd"></path>
                                            ...
                                            <div class="min-w-0 flex-1">
                                                <div>
                                                    <div class="text-sm">
                                                        <a href="#" class="font-medium text-gray-900">Administrador 2</a>
                                                    </div>
                                                ...
                                                <div class="mt-2 text-sm text-gray-700">
                                                    <p>
                                                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Et diam cursus quis sed purus nam.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="relative flex items-start space-x-3">
                                            ...
                                            <div class="min-w-0 flex-1 py-1.5">
                                                <div class="text-sm text-gray-500">
                                                    <a href="#" class="font-medium text-gray-900">Administrador 1</a>
                                                    <!-- space -->
                                                    Asignó a
                                                    <!-- space -->
                                                    <a href="#" class="font-medium text-gray-900">Administrador 2</a>
                                ...
                                <li>
                                    <div class="relative pb-8">
                                        ...
                                        <div class="relative flex items-start space-x-3">
                                            ...
                                            <span class="mr-0.5">
                                              <a href="#" class="font-medium text-gray-900">Admnistrador</a>
                                                <!-- space -->
                                              Cambio el estado a
                                            </span>
                                                ...
                                                <a href="#" class="relative inline-flex items-center rounded-full border border-gray-300 px-3 py-0.5 text-sm">
                                                  ...
                                                  <span class="ml-3.5 font-medium text-gray-900">En revisión</span>
                                                </a>
                                                                            <!-- space -->
                                    ...
                                    <div class="relative pb-8">
                                        <div class="relative flex items-start space-x-3">
                                            ...
                                            <div class="min-w-0 flex-1">
                                                <div>
                                                    <div class="text-sm">
                                                        <a href="#" class="font-medium text-gray-900">Sistema</a>
                                                    </div>
                                                    <p class="mt-0.5 text-sm text-gray-500">
                                                        20/08/21
                                                    </p>

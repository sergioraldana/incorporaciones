<div class="py-12" aria-labelledby="quick-links-title">
    ...
    <div class="pb-8 mx-auto">
        <div>
            ...
            <p class="mt-2 text-sm text-gray-500">Gestiones de Estudios de Grado (licenciatura) Determinado para los
                profesionales egresados a nivel de grado (licenciatura) de Instituciones de Estudios Superiores de
                primera categoría en el Extranjero, y que desean incorporar sus estudios a la Universidad de San Carlos
                de Guatemala, cumpliendo con lo establecido en la legislación guatemalteca.</p>
        </div>
    </div>

    <div
        class="rounded-lg bg-gray-200 overflow-hidden shadow-lg divide-y divide-gray-200 sm:divide-y-0 sm:grid sm:grid-cols-2 sm:gap-px">
        <h2 class="sr-only" id="quick-links-title">Opciones</h2>
        ...
        <div
            ...
            <div>
                      <span class="rounded-lg inline-flex p-3 bg-blue-50 text-blue-700 ring-4 ring-white">
                          <svg class="h-6 w-6" x-description="Heroicon name: outline/globe"
    ...
    <div class="pt-12 pb-8 mx-auto">
        <div>
            ...
            <p class="mt-2 text-sm text-gray-500">Dirigido a los profesionales egresados a nivel postgrado (maestría,
                especialización, doctorado o post - doctorado), de Instituciones de Estudios Superiores de primera
                categoría en el Extranjero, que ya cuentan con título profesional facultativo de la Universidad de San
                Carlos de Guatemala ó Universidad privada legalmente autorizada para funcionar en Guatemala.</p>
        </div>
    </div>
    ...
    <section aria-labelledby="quick-links-title">
        <div
            ...
            <div
                ...
                <div>
                      <span class="rounded-lg inline-flex p-3 bg-blue-50 text-blue-700 ring-4 ring-white">
                        <svg class="h-6 w-6" x-description="Heroicon name: outline/clock"
                             xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                             aria-hidden="true">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div
                ...
                <div>
                      <span class="rounded-lg inline-flex p-3 bg-blue-50 text-blue-700 ring-4 ring-white">
                        <svg class="h-6 w-6" x-description="Heroicon name: outline/badge-check"
                             xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                             aria-hidden="true">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div
                ...
                <div>
                      <span class="rounded-lg inline-flex p-3 bg-blue-50 text-blue-700 ring-4 ring-white">
                        <svg class="h-6 w-6" x-description="Heroicon name: outline/academic-cap"
                             xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                             aria-hidden="true">

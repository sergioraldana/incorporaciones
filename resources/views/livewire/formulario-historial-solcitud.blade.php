    ...
    <div class="md:grid md:grid-cols-3 md:gap-6">
        <div class="md:col-span-1">
            <div class="px-4 sm:px-0">
                <h3 class="text-lg font-medium leading-6 text-gray-900">Historial de solicitud</h3>
                <p class="mt-1 text-sm text-gray-600">
                    Agregue una actualización sobre la solicitud.
                </p>
            </div>
        </div>
                    ...
                    Estado aquí
                        ...
                        <div>
                            ...
                            <p class="mt-2 text-sm text-gray-500">
                                Breve descripción del comentario de actualización de estado o documento agregado.
                            </p>
                        </div>
